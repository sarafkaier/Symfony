...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // oc_platform_home
        if (preg_match('#^/(?P<_locale>en|fr)/platform(?:/(?P<page>\\d*))?$#sD', $pathinfo, $matches)) {
        ...
        // oc_platform_view
        if (preg_match('#^/(?P<_locale>en|fr)/platform/advert/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
        ...
        // oc_platform_add
        if (preg_match('#^/(?P<_locale>en|fr)/platform/add$#sD', $pathinfo, $matches)) {
        ...
        // oc_platform_edit
        if (preg_match('#^/(?P<_locale>en|fr)/platform/edit/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
        ...
        // oc_platform_delete
        if (preg_match('#^/(?P<_locale>en|fr)/platform/delete/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/_console')) {
            ...
            if ('/_console' === $pathinfo) {
                $ret = array (  '_controller' => 'coresphere_console.controller:consoleAction',  '_route' => 'console',);
                if (!in_array($canonicalMethod, array('GET'))) {
                    $allow = array_merge($allow, array('GET'));
                    goto not_console;
                }
            ...
            // console_exec
            if (0 === strpos($pathinfo, '/_console/commands') && preg_match('#^/_console/commands(?:\\.(?P<_format>json))?$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'console_exec')), array (  '_controller' => 'coresphere_console.controller:execAction',  '_format' => 'json',));
                if (!in_array($requestMethod, array('POST'))) {
                    $allow = array_merge($allow, array('POST'));
